        ...
        <main className="flex flex-col items-center overflow-x-hidden">
                        ...
                        <div className="col-span-12 lg:col-span-5">
                            <div className='bg-bgBrownLight py-10 lg:py-20 px-6 lg:px-12 rounded-xl'>
                                ...
                                <p className="leading-7">Hola, soy Teymar. Y en <strong> Psicología con Tey</strong>,
                                    ...
                                    pleno.
                                    Mi objetivo es acompañarte en este viaje, brindándote las herramientas y el
                                    apoyo
            ...
            <div className="flex justify-center px-4 lg:p-0 mb-10">
                <div className="max-w-[1200px]  w-full">
                    ...
                    <p className="text-center text-darkBlue text-lg mb-10">Estas son las creencias que pueden
                        estar
            ...
            <div className="bg-bgBrown w-full py-16 lg:pt-52 lgpb-16 px-4 relative my-20 flex flex-col items-center">
                <div
                    ...
                    <p className="text-white tracking-[2px] text-center font-medium text-md">Si este eres tú,
                        entonces...</p>
                    <h4 className="text-white text-center text-[2.813rem] font-bold whitespace-nowrap">¡Estás en
                        el
                        lugar correcto!</h4>
                </div>
                <div
                ...
                <div className="grid grid-cols-12 lg:gap-20 lg:px-24 items-center max-w-[1200px]">
            ...
            <div className="max-w-[1200px]">
                ...
                <div className="grid grid-cols-12 lg:gap-5 px-4 lg:px-24 items-center">
                    <div className="col-span-12 lg:col-span-6 flex justify-center mb-8 lg:mb-0 lg:block">
                        <Image alt="Productos digitales" src="/img/ebook/digital-product.png" width={530}
                               height={530}
                    ...
                    <div className="col-span-12 lg:col-span-6">
                        ...
                        <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mt-4">
                            ...
                            disfrutar de lo que realmente importa? En un mundo donde las demandas parecen no tener
                            fin,
                        ...
                        <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mt-4">
                            ...
                            simple manual de organización; es tu guía para transformar la manera en que vives cada
                            día.
                            Este libro electrónico te proporcionará herramientas prácticas y estrategias probadas
                            que te
                            permitirán maximizar tu productividad sin sacrificar tu salud mental ni tu felicidad.
                        </p>

                        <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mt-4">
                            Descubre como establecer prioridades claras, eliminar la procrastinación y crear un
                            horario
                            flexible que se adapte a tus necesidades, todo mientras te aseguras de que haya espacio
                            para
                            el descanso, la creatividad y las relaciones personales.
                        </p>

                        <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mt-4">
                            No dejes que el estrés y la sobrecarga te controlen. Aprende a gestionar tu tiempo de
                            manera
                            consciente y alcanza tus metas con mayor facilidad y satisfacción. ¡Haz de la
                            productividad
                        ...
                        <div className="flex flex-col items-center mt-5">
                            ...
                            <Link href="https://pay.hotmart.com/Q95102650L?bid=1724622895733"
                                  className="w-full flex justify-center" target="_blank">
                                <Button
                                    variant="purple"
            ...
            <div className="flex flex-col items-center max-w-[1200px]">
                ...
                <div className="max-w-[600px] px-4">
                    ...
                    <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mb-4">
                        <strong>Bono 2: Planificador 2024:</strong> Un planificador completo que te ayudará
                        a
                        establecer metas
                    ...
                    <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mb-4">
                        <strong>Bono 3: Guía de Técnicas de Respiración:</strong> Aprende a manejar el
                        estrés y
                        mejorar tu
                        concentración con esta guía práctica que te enseñará técnicas de respiración
                        efectivas
                    ...
                    <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mb-4">
                        ...
                        infografía clara y
                        fácil de seguir que te mostrará como practicar la respiración diafragmática, una
                        técnica
                        poderosa para reducir la ansiedad y mejorar tu bienestar general.
                    </p>

                    <p className="text-darkBlue text-md lg:text-xl leading-[2rem] mb-4">
                        Este paquete completo estará disponible, pero debes estar atento: <strong>la oferta
                        será
                        limitada </strong> y solo unos pocos tendrán la oportunidad de obtener estos
                        valiosos
                        recursos
                        adicionales.
                    </p>
                    ...
                    <div className="flex flex-col items-center mt-5">
                        ...
                        <Link href="https://pay.hotmart.com/Q95102650L?bid=1724622895733"
                            ...
                            <Button
                                variant="purple"
                                className=" w-full lg:w-[17.25rem] h-[3.75rem] rounded-2xl text-md">¡COMPRAR
                                AHORA!</Button>
                        </Link>
                    </div>
            ...
            <div className="my-10 flex flex-col items-center px-4">
                ...
                <Link href="https://www.instagram.com/psicologiacontey" target="_blank">
                    <Button
                        className="bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] animate-glow">@psicologiacontey</Button>
                </Link>
